...
export default function ReviewPage() {
  ...
  const allocatedTokens = Object.values(tokenAllocation).reduce(
    (sum, val) => sum + val,
    0
  );
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">
            Select your top 3 concepts and allocate tokens to evaluate them
          </p>
        </div>
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-xl font-semibold text-gray-100">
                Step 1: Select Top 3 Concepts
              </h2>
              <p className="text-sm text-gray-400 mt-1">
                Click on concepts to select ({selectedConcepts.length}/3
                selected)
              </p>
            </div>
          ...
          <div className="glass rounded-xl p-6 mb-6 border border-gray-700/50">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-gray-400 mt-1">
                  Distribute {totalTokens} tokens among your top 3 concepts
                  based on feasibility, innovation, and impact
                </p>
              </div>
            ...
            <div className="space-y-4">
              {selectedConcepts.map((noteId) => {
                ...
                return (
                  <div
                    key={noteId}
                    className="p-4 glass-light rounded-lg border border-gray-700/50"
                  >
        ...
        <div className="flex justify-end">
          <button
            ...
            disabled={
              selectedConcepts.length !== 3 || allocatedTokens !== totalTokens
            }
